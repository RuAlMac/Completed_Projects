...
void transmitAcknowledgement() { //EXPERIMENTAL*******************************************
  commandAcknowledge[0] = true;
  delay(20);

  radio.openWritingPipe(address);
  radio.stopListening();
  radio.write(&commandAcknowledge[0], sizeof(commandAcknowledge[0]));
  delay(20);

  commandAcknowledge[0] = false;
  radio.startListening();
}
